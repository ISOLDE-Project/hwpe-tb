...
#define  CONTI_TRACE_1(class,txt)               std::ostringstream _os;                                        \
...
#define  CONTI_TRACE_2(class,txt1,txt2)               std::ostringstream _os;                                        \
                                                auto pczs_doqw=__PRETTY_FUNCTION__;                          \
                                                int len = strlen(pczs_doqw);                                 \
                                                _os<<"  ( "<<txt1<<" ) "<<" [ "<<txt2<<" ]  ";                                       \
                                                if(len <80 && len> 0 ) _os<<pczs_doqw; else _os<<"unknown";    \
...
#define  CONTI_INFO(class, txt)            class::getInstance().info(__FILE__,__LINE__);             \
